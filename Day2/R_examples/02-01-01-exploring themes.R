...
## Shiny example for exploring Bootswatch themes
#Uses Prompt as base font and Pacifico as heading font
...
ui <- page_navbar(
  ...
  # theme = bs_theme_update(theme = bs_theme(bootswatch = 'flatly'), base_font = font_google("Prompt"),
  #                         heading_font = font_google("Pacifico"), font_scale = 1.25, `enable-gradients` = TRUE),
