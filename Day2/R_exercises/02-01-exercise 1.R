...
#  1. Choose a preset Bootswatch theme you prefer from the Bootswatch website (https://bootswatch.com) and apply to the app
#  2. Set the base font to 'Nunito Sans' (Google), heading font to 'Montserrat' (Google), and code font to 'Courier New'
#  3. Change primary theme color to #E69F00
