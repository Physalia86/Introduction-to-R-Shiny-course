...
<h1 class="text-indigo-pink">Intro to Shiny, Day 1<h1>
...
## Building Shiny apps {.text-lime-cyan}

Developers can create Shiny apps in a variety of ways:

::: incremental
- Creating a single app.R file
- Creating a 2-file app using ui.R and server.R
- Using an [R Markdown document](https://shiny.posit.co/r/articles/build/interactive-docs/)
- Using Quarto to create interactive [docs](https://quarto.org/docs/interactive/shiny/), [dashboards](https://quarto.org/docs/dashboards/interactivity/shiny-r.html), and [slides](https://quarto.org/docs/presentations/revealjs/)
:::
...
# Your turn {background-color="#ff9900aa" transition="slide-in"}
